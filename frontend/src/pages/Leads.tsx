  ...
  const columns = [
    {
      ...
      header: "Name",
      width: 180,
      render: (r: Lead) => `${r.first_name} ${r.last_name}`,
    },
    ...
    },
    {
      ...
      render: (r: Lead) => (
        <span
          className={`inline-block px-2 py-0.5 rounded-full text-xs font-medium ${STATUS_COLORS[r.status] || ""}`}
        >
    ...
    },
    {
      ...
      header: "Created",
      width: 130,
      render: (r: Lead) => new Date(r.created_at).toLocaleDateString(),
    },
    {
      key: "actions",
      header: "",
      ...
      <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500">
            Manage your pipeline from mobile or desktop.
          </p>
        </div>
